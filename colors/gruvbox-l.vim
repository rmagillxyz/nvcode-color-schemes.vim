...
hi Comment guifg=#a89984 ctermfg=138 guibg=NONE ctermbg=NONE gui=italic cterm=italic
...
hi Float guifg=#b65619 ctermfg=130 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
...
hi SpecialComment guifg=#a89984 ctermfg=138 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
...
hi VertSplit guifg=#a89984 ctermfg=138 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
...
hi TSComment guifg=#a89984 ctermfg=138 guibg=NONE ctermbg=NONE gui=italic cterm=italic
...
hi htmlLink guifg=#33c6bd ctermfg=79 guibg=NONE ctermbg=NONE gui=underline cterm=underline
...
hi markdownHeadingDelimiter guifg=#b65619 ctermfg=130 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
...
hi markdownListMarker guifg=#b65619 ctermfg=130 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi markdownOrderedListMarker guifg=#b65619 ctermfg=130 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi markdownRule guifg=#5c6370 ctermfg=241 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi markdownUrl guifg=#33c6bd ctermfg=79 guibg=NONE ctermbg=NONE gui=underline cterm=underline
hi CocExplorerIndentLine guifg=#5c6370 ctermfg=241 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi CocExplorerBufferRoot guifg=#33c6bd ctermfg=79 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi CocExplorerFileRoot guifg=#33c6bd ctermfg=79 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
...
hi EasyMotionTarget guifg=#fb5002 ctermfg=202 guibg=NONE ctermbg=NONE gui=bold cterm=bold
hi EasyMotionTarget2First guifg=#fb5002 ctermfg=202 guibg=NONE ctermbg=NONE gui=bold cterm=bold
hi EasyMotionTarget2Second guifg=#fb5002 ctermfg=202 guibg=NONE ctermbg=NONE gui=bold cterm=bold
hi EasyMotionShade guifg=NONE ctermfg=NONE guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi StartifyNumber guifg=#b65619 ctermfg=130 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
...
hi StartifySpecial guifg=#33c6bd ctermfg=79 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
...
hi StartifyFile guifg=#33c6bd ctermfg=79 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
...
hi WhichKeyGroup guifg=#ebdbb2 ctermfg=223 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi WhichKeyDesc guifg=#33c6bd ctermfg=79 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi diffAdded guifg=#98971a ctermfg=100 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi diffRemoved guifg=#b65619 ctermfg=130 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
...
hi LspDiagnosticsSignError guifg=#fb5002 ctermfg=202 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
...
hi LspDiagnosticsVirtualTextError guifg=#fb5002 ctermfg=202 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
...
hi BufferCurrentTarget guifg=#b65619 ctermfg=130 guibg=#363636 ctermbg=237 gui=bold cterm=bold
...
hi HopUnmatched guifg=#a89984 ctermfg=138 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
