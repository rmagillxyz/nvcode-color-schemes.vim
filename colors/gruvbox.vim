...
hi Normal guifg=#ebdbb2 ctermfg=223 guibg=#0c090a ctermbg=232 gui=NONE cterm=NONE
...
hi SignColumn guifg=NONE ctermfg=NONE guibg=#0c090a ctermbg=232 gui=NONE cterm=NONE
...
hi DiffAdd guifg=#0c090a ctermfg=232 guibg=#d79921 ctermbg=172 gui=NONE cterm=NONE
hi DiffChange guifg=#d79921 ctermfg=172 guibg=NONE ctermbg=NONE gui=underline cterm=underline
hi DiffDelete guifg=#0c090a ctermfg=232 guibg=#cc241d ctermbg=160 gui=NONE cterm=NONE
hi DiffText guifg=#0c090a ctermfg=232 guibg=#d79921 ctermbg=172 gui=NONE cterm=NONE
...
hi PmenuSel guifg=#0c090a ctermfg=232 guibg=#458588 ctermbg=66 gui=NONE cterm=NONE
...
hi QuickFixLine guifg=#0c090a ctermfg=232 guibg=#d79921 ctermbg=172 gui=NONE cterm=NONE
hi Search guifg=#0c090a ctermfg=232 guibg=#ebdbb2 ctermbg=223 gui=NONE cterm=NONE
...
hi TabLineFill guifg=NONE ctermfg=NONE guibg=#0c090a ctermbg=232 gui=NONE cterm=NONE
hi Terminal guifg=#ebdbb2 ctermfg=223 guibg=#0c090a ctermbg=232 gui=NONE cterm=NONE
...
hi WildMenu guifg=#0c090a ctermfg=232 guibg=#458588 ctermbg=66 gui=NONE cterm=NONE
hi EndOfBuffer guifg=#0c090a ctermfg=232 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
...
hi BufferCurrent guifg=#ebdbb2 ctermfg=223 guibg=#0c090a ctermbg=232 gui=NONE cterm=NONE
hi BufferCurrentIndex guifg=#689d6a ctermfg=71 guibg=#0c090a ctermbg=232 gui=NONE cterm=NONE
hi BufferCurrentMod guifg=#ebdbb2 ctermfg=223 guibg=#0c090a ctermbg=232 gui=NONE cterm=NONE
hi BufferCurrentSign guifg=#689d6a ctermfg=71 guibg=#0c090a ctermbg=232 gui=NONE cterm=NONE
hi BufferCurrentTarget guifg=#cc241d ctermfg=160 guibg=#0c090a ctermbg=232 gui=bold cterm=bold
hi BufferCurrentIcon guifg=#689d6a ctermfg=71 guibg=#458588 ctermbg=66 gui=NONE cterm=NONE
hi BufferVisible guifg=#ebdbb2 ctermfg=223 guibg=#0c090a ctermbg=232 gui=NONE cterm=NONE
hi BufferVisibleIndex guifg=#ebdbb2 ctermfg=223 guibg=#0c090a ctermbg=232 gui=NONE cterm=NONE
hi BufferVisibleMod guifg=#ebdbb2 ctermfg=223 guibg=#0c090a ctermbg=232 gui=NONE cterm=NONE
hi BufferVisibleSign guifg=#ebdbb2 ctermfg=223 guibg=#0c090a ctermbg=232 gui=NONE cterm=NONE
hi BufferVisibleTarget guifg=#cc241d ctermfg=160 guibg=#0c090a ctermbg=232 gui=bold cterm=bold
